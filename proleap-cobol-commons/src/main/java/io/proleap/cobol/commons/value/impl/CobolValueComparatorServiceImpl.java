...
public class CobolValueComparatorServiceImpl implements CobolValueComparatorService {
	...
	public Integer compare(final CobolValue valueLeft, final CobolValue valueRight, final ProgramUnit programUnit) {
		...
		final String stringValueLeft = Java11To8.stripTrailing(valueService.getAsString(valueLeft, programUnit));
		final String stringValueRight = Java11To8.stripTrailing(valueService.getAsString(valueRight, programUnit));
