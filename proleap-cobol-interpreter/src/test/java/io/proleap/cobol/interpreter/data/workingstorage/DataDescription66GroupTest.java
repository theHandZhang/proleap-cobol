...
public class DataDescription66GroupTest extends TestBase {
	...
	public void test() throws Exception {
		...
		assertEquals(Java11To8.repeat(" ", 20), valueService.getString(getValue("ITEMS", programUnit, state)));
		assertEquals(Java11To8.repeat(" ", 20), valueService.getString(getValue("ITEMZ", programUnit, state)));
	}
}
