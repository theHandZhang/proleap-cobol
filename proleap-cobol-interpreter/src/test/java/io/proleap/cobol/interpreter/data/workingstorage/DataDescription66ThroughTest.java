...
public class DataDescription66ThroughTest extends TestBase {
	...
	public void test() throws Exception {
		...
		assertEquals(Java11To8.repeat(" ", 10), valueService.getString(getValue("ITEM3", programUnit, state)));
		assertEquals(Java11To8.repeat(" ", 10), valueService.getString(getValue("ITEM4", programUnit, state)));

		assertEquals(Java11To8.repeat(" ", 40), valueService.getString(getValue("ITEMS", programUnit, state)));
		assertEquals(Java11To8.repeat(" ", 30), valueService.getString(getValue("ITEMZ", programUnit, state)));
	}
}
